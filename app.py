...
#         "slide": "Slides 6, 10, 12",
#         "meaning": "Shows how short, medium, and long moving averages smooth noise and describe trend regimes.",
#     },
#     "daily_returns_distribution.png": {
#         "label": "Daily Returns Distribution",
#         "slide": "Slides 9, 10, 13",
...
#     1. Pick one ticker.
#     2. Explain the four metrics.
#     3. Show Trend, Probability, Insights.
#     4. Open Slide Figures for visuals.
#     """
# )
# st.sidebar.divider()
# st.sidebar.caption("Generated artifacts are read from SQLite, outputs/figures, and outputs/reports.")
...
#     ["Trend", "Probability", "Insights", "Slide Figures", "Limitations"]
# )
...
#     st.caption("Monthly bars convert daily movement into a cleaner trend story for slides and demo discussion.")
...
#         <strong>Evaluator note:</strong> probability here means historical up/down frequency. It does not estimate
#         future return, guarantee direction, or replace risk analysis.
#         </div>
#         """,
#         unsafe_allow_html=True,
#     )
...
#     st.write(
#         "The report explains the computed metrics in presentation language: trend, volatility, moving-average signal, "
#         "chart interpretation, and a caution note."
#     )
#     st.markdown(read_insights())

# with tab_figures:
#     st.subheader("Figures Mapped to Slides")
#     st.write("Each saved figure has a clear role in the 15-slide presentation.")
#     for filename, details in FIGURE_GUIDE.items():
#         path = FIGURES_DIR / filename
#         if path.exists():
#             st.markdown(f"**{details['label']}** · use on {details['slide']}")
...
#     st.markdown(
#         """
#         - This project analyzes historical OHLCV data only.
#         - It is not financial advice and does not recommend buying, selling, or holding any stock.
#         - Historical up/down probability is descriptive frequency, not reliable price prediction.
#         - yfinance data can be delayed, revised, unavailable, or affected by ticker-specific issues.
#         - Moving averages and volatility are lagging indicators and should be interpreted with context.
#         """
#     )
